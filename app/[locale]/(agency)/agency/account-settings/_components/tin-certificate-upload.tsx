...
type TinCertificateUploadProps = {
  value?: string;
  disabled?: boolean;
...
const TinCertificateUpload = ({
  value,
  disabled = false,
  onChange,
}: TinCertificateUploadProps) => {
  ...
  return (
    <div className="space-y-2">
      <Label className="text-orange">Upload TIN Certificate</Label>

      <div className="relative group">
        <label
          htmlFor="tin-certificate-upload"
...
export default TinCertificateUpload;