...
const NamePill = ({ text }: { text: string }) => (
  <span className="inline-flex items-center rounded-full bg-[#F5F5DC] px-3 py-1 text-sm font-medium text-Primary">
    {text}
  </span>
);
...
export default function CampaignSummaryHeader({
  ...
  return (
    <div className="min-w-0 flex-1">
      ...
      <h2 className="mt-3 text-base font-semibold leading-snug text-white sm:text-base">
        {title}
      </h2>
        ...
        <div className="mt-4">
          <div className="mb-3">
            {showInfluencerSection ? (
              ...
              <div className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-white bg-white/70 text-xs font-semibold text-Primary">
