      ...
      <CardContent className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <RadioGroup
            value={campaignType}
            onValueChange={(value) =>
              handleCampaignTypeChange(value as CampaignType)
            }
            className="space-y-4"
          >
            <Label
            ...
            >
              <div className="space-y-1 text-Primary">
                <p className="font-semibold text-base">{t("paidAd")}</p>
                <p className="text-sm">
                  {t("launchTargetedAdvertisingCampaign")}
                </p>
              </div>
            ...
            >
              <div className="space-y-1 text-Primary">
                ...
                <p className="text-sm">
                  {t("partnerWithInfluencerForPromotion")}
                </p>
              </div>
              <RadioGroupItem
