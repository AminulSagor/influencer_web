...
export default function ProfileSummaryCard({
  ...
  return (
    <div className="rounded-2xl bg-linear-to-r from-Primary to-light-green text-white flex sm:items-center sm:justify-center p-4 ">
      <div className="flex flex-col items-center justify-between gap-8 px-3 md:px-4 sm:flex-row sm:gap-12 xl:gap-20 xl:px-4 w-full xl:max-w-2xl overflow-y-scroll no-scrollbar">
        {/* Left: Avatar + Info */}
        ...
        <div className="flex w-full flex-col gap-4 pl-3 sm:pl-0 sm:max-w-56">
          {/* Social handles */}
