...
export default function ProfileSummaryCard() {
  return (
    <div className="rounded-2xl bg-linear-to-r from-[#5E7F3A] to-[#7FA35A] text-white flex items-center justify-center p-4 ">
      <div className="flex items-center justify-between xl:px-4 w-full xl:max-w-xl px-3 md:px-4 overflow-y-scroll no-scrollbar">
        {/* Left: Avatar + Info */}
        ...
        <div className="flex flex-col items-end gap-4">
          ...
          {/* Logout */}
          <button className="px-6 py-1.5 rounded-lg bg-[#F1F6DE] text-[#2D5016] text-sm font-medium hover:opacity-90 flex items-center gap-2">
