...
const PendingJobList = ({ search, sort }: PendingJobListProps) => {
  ...
  const fetchJobs = useCallback(async () => {
    try {
      ...
      toast.error(error instanceof Error ? error.message : "Failed to load pending jobs");
    } finally {
      setLoading(false);
    }
  }, [search, sort, page]);
